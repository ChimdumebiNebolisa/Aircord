...
def run_memory_loop(
    ...
    *,
    ...
    if pm25 is None:
        raise RuntimeError(f"Sensor reading has no PM2.5 value: {sensor_id}")
    ...
    reasoning_text = (
        ...
        "The stored estimate is a transparent PM2.5 proxy, not a validated AQI claim. "
    ...
    with repository.transaction() as transaction:
        ...
        transaction.upsert_cell_estimate(cell_id, pm25, confidence)
